...
@WebServlet("/FindTopSellWithTypeAjax")
public class FindTopSellWithTypeAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public FindTopSellWithTypeAjaxServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Computer> groupComputers = computerDao.getGroupComputerTopSellWithType(type);
